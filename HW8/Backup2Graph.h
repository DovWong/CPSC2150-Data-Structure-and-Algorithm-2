...
public:
    ...
    Graph(unsigned int** maze, int n, int o){

        BuildVertices(n, o);
        BuildAdjacencyList(maze, n, o);
        BuildEdgeList(maze, n, o);
    }

    void BuildVertices(int n, int o) {
    ...
    void BuildAdjacencyList(unsigned int** maze, int n, int o) {
        for (int a = 0; a < n * o; a++) {
    ...
    void BuildEdgeList(unsigned int** maze, int n, int o) {
...
//
    ...
    bool DFS(int curX, int curY, int endX, int endY, vector<bool>& isVisited) {
        ...
        //cout << "curX: " << curX << ", curY: " << curY << ", curIndex: " << curIndex << endl; // for debug
